                                            ...
                                            <td style="padding: 18px 20px; text-align: center;">
                                                <div style="display: flex; justify-content: center; gap: 8px; align-items: center;">
                                                    ...
                                                    <div style="display: flex; background: #f1f5f9; padding: 4px; border-radius: 12px; gap: 6px; align-items: center; border: 1px solid #e2e8f0;">
                                                        <a href="update_status.php?id=<?php echo $pay['id']; ?>&status=pending" title="Mark Pending" style="background: #f59e0b; width: 14px; height: 14px; border-radius: 50%; opacity: <?php echo $pay['status'] === 'pending' ? '1' : '0.2'; ?>; display: block;"></a>
                                                        <a href="update_status.php?id=<?php echo $pay['id']; ?>&status=completed" title="Mark Completed" style="background: #10b981; width: 14px; height: 14px; border-radius: 50%; opacity: <?php echo $pay['status'] === 'completed' ? '1' : '0.2'; ?>; display: block;" onclick="return confirm('Mark this payment as completed?')"></a>
                                                        <a href="update_status.php?id=<?php echo $pay['id']; ?>&status=failed" title="Mark Failed" style="background: #ef4444; width: 14px; height: 14px; border-radius: 50%; opacity: <?php echo $pay['status'] === 'failed' ? '1' : '0.2'; ?>; display: block;"></a>
                                                    </div>
